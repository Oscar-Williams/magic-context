...
export const DreamTasksSchema = z
    .object({
        ...
        "maintain-docs": DreamTaskBaseConfigSchema.extend({
            max_tokens: z.number().int().positive().default(12000).describe("Maximum combined token count of proposed ARCHITECTURE.md and STRUCTURE.md"),
        }).default(() => ({ ...DreamTaskBaseConfigSchema.parse(defaultTaskConfig("maintain-docs")), max_tokens: 12000 })),
